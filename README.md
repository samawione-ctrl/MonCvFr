...
| | |
| :--- | :--- |
| **📞 Téléphone** | 06 36 67 44 17 |
| **📍 Adresse** | Sidi Kacem, Morocco |
| **📅 Date de naissance** | 08/07/1999 |
...
- Pilotage des programmes de production et de commercialisation des semences
- Analyse des besoins locaux et adaptation de l’offre commerciale
- Mise en œuvre du plan d’action régional (production, logistique, promotion)
- Animation et accompagnement des acteurs agricoles (multiplicateurs, distributeurs, clients)

**Réalisations clés :**
- Gestion complète de la production semencière (contractualisation, suivi cultural, pré-agréage)
- Organisation de l’industrialisation, du conditionnement et du stockage
- Contrôle qualité et suivi phytosanitaire des semences
- Développement du portefeuille clients et suivi des indicateurs commerciaux
- Mise en place d’essais démonstratifs et formation technique des partenaires
...
Projet de développement du système d’irrigation de la région du Gharb.

- Conception et validation des outils d’enquête
- Réalisation de plus de **500 enquêtes terrain** sur 15 communes
- Collecte, contrôle et saisie des données socio-économiques
- Contribution à la rédaction du rapport final du projet
...
- Stratégie commerciale et développement du marché agricole
- Contrôle phytosanitaire et variétal des semences (ONSSA)
- Analyse de données, reporting et aide à la décision
- Encadrement technique et conseil agricole
...
- **Imagerie drone :** Pix4D, Agisoft Metashape
- **Développement web (bases) :** HTML, CSS, PHP, JavaScript
...
---
[Télécharger mon CV (PDF)](https://raw.githubusercontent.com/samawione-ctrl/MonCvFr/main/assets/img/CVFR_HAMMOUYAT.pdf)

[Download my Resume (PDF)](https://raw.githubusercontent.com/samawione-ctrl/MonCvFr/main/assets/img/CVENG_HAMMOUYAT.pdf)
